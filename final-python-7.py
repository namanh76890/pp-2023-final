...
class CitationManager:
    ...
    def search_citations(self, query):
        ...
        # Convert the authors string back to a list
        formatted_results = []
        for result in results:
            authors_list = Citation().string_to_authors(result[1])
            formatted_result = (result[0], authors_list, result[2], result[3], result[4], result[5], result[6])
